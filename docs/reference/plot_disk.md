...
[`hyperbolizeEV()`](hyperbolizeEV.md) on the Poincaré disk, with points
colored by cluster and global centroids highlighted.
...
- out:
  ...
  A list, typically the output of [`hyperbolizeEV()`](hyperbolizeEV.md)
  or [`hyperbolize()`](hyperbolize.md).
